...
((ChatBot,Bot,CMD,Version) => {
    ...
    /*
        ...
        2. (Create New Script)
        https://github.com/BadNintendo/Chatbot
    */
    //Do not Edit below These lines unless youre able to code javascript/css/html
    ((Version.encrypt+Version.title) == (Version.encrypt+'00b8d27c8e390f8b112cb4334d82')) ? ChatBot.version = '1.14' : alert('ChatBot cannot operate!');
